...
import co.edu.uniajc.cajero.model.Tarjeta;

/**
 * Home object for domain model class Tarjeta.
 * @see co.edu.uniajc.cajero.dao.Tarjeta
 * @author Hibernate Tools
 */
public class TarjetaDao {

	private static final Log log = LogFactory.getLog(TarjetaDao.class);
	...
	public Tarjeta findById(java.lang.Integer id) {
		...
		try {
			Tarjeta instance = (Tarjeta) sessionFactory.getCurrentSession().get("co.edu.uniajc.cajero.dao.Tarjeta", id);
			if (instance == null) {
	...
	public List findByExample(Tarjeta instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("co.edu.uniajc.cajero.dao.Tarjeta")
